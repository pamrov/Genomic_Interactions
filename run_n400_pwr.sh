...
#616,138 (start point for n=400,000)

#SBATCH --job-name=n400_pwr
#SBATCH --qos=normal
#SBATCH --partition=shas
#SBATCH --ntasks=4
#SBATCH --time=24:00:00
#SBATCH --array=[616138-821520:210]
  #Yields 978 directories/task arrays
  #n400 endpt: 821,516
  #JOB ARRAY: START-END:STEP_SIZE
#SBATCH --output=/scratch/summit/paro1093/power_rs169/trueEffect2/slurm/trueEff-n400-startpt-%a.out
...
do
 ...
 if [[ -f "/scratch/summit/paro1093/power_rs169/trueEffect2/${sind}/trueEff2_n400000_sim_#_${counter}.csv" ]]; then
...
head -1 /scratch/summit/paro1093/power_rs169/trueEffect2/${sind}/*${sind}.csv > /scratch/summit/paro1093/power_rs169/trueEffect2/summary_n400000_${sind}.csv

#add non-matching (--v) lines to our new summary file (so headers don't repeat):
cat /scratch/summit/paro1093/power_rs169/trueEffect2/${sind}/*.csv |grep -v "sample_size" >> /scratch/summit/paro1093/power_rs169/trueEffect2/summary_n400000_${sind}.csv
