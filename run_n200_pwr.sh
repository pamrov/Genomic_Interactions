...
#205,379+1 = 205,380 (start point for n=200,000)

#SBATCH --job-name=n200_pwr
#SBATCH --qos=normal
#SBATCH --partition=shas
#SBATCH --ntasks=4
#SBATCH --time=24:00:00
#SBATCH --array=[205380-410760:210]
#SBATCH --output=/scratch/summit/paro1093/power_rs169/trueEffect2/slurm/trueEff-n200-startpt-%a.out
...
do
 ...
 if [[ -f "/scratch/summit/paro1093/power_rs169/trueEffect2/${sind}/trueEff2_n200000_sim_#_${counter}.csv" ]]; then
...
head -1 /scratch/summit/paro1093/power_rs169/trueEffect2/${sind}/*${sind}.csv > /scratch/summit/paro1093/power_rs169/trueEffect2/summary_n200000_${sind}.csv

#add non-matching (--v) lines to our new summary file (so headers don't repeat):
cat /scratch/summit/paro1093/power_rs169/trueEffect2/${sind}/*.csv |grep -v "sample_size" >> /scratch/summit/paro1093/power_rs169/trueEffect2/summary_n200000_${sind}.csv
